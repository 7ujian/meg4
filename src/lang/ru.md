...
Дополнительные [клавиатура] сочетания клавиш, которые вы также можете использовать при редактировании
исходного кода:

| Клавиша | Описание |
|-----------------------------|---------------------------------------------------------------------------------------|
| <kbd>Ctrl</kbd>+<kbd>F</kbd> | Найти строку |
| <kbd>Ctrl</kbd>+<kbd>G</kbd> | Найти снова |
| <kbd>Ctrl</kbd>+<kbd>H</kbd> | Поиск и замена (в выделенном тексте или, при его отсутствии, во всем исходном коде) |
| <kbd>Ctrl</kbd>+<kbd>J</kbd> | Перейти к строке |
| <kbd>Ctrl</kbd>+<kbd>D</kbd> | Перейти к определению функции |
| <kbd>Ctrl</kbd>+<kbd>N</kbd> | Список закладок |
| <kbd>Ctrl</kbd>+<kbd>B</kbd> | Переключить закладку на текущей строке |
| <kbd>Ctrl</kbd>+<kbd>▴</kbd> | Перейти к предыдущей закладке |
| <kbd>Ctrl</kbd>+<kbd>▾</kbd> | Перейти к следующей закладке |
| <kbd>Ctrl</kbd>+<kbd>◂</kbd> | Перейти к началу предыдущего слова |
| <kbd>Ctrl</kbd>+<kbd>▸</kbd> | Перейти к концу следующего слова |
| <kbd>Ctrl</kbd>+<kbd>,</kbd> | Уменьшить отступ выделения |
| <kbd>Ctrl</kbd>+<kbd>.</kbd> | Увеличить отступ выделения |
| <kbd>Home</kbd> | Переместить курсор в начало строки |
| <kbd>End</kbd> | Переместить курсор в конец строки |
| <kbd>PgUp</kbd> | Переместить курсор на 42 строки (одну страницу) вверх |
...
<dl>
<dt>Описание</dt><dd>
Начать прослушивание клиентских подключений, организовать игру по локальной сети. Не блокирует,
[net_conn] сообщает об установлении соединения.
</dd>
<dt>Параметры</dt><dd>
| Аргум. | Описание |
| num | максимальное количество игроков, до 16 |
</dd>
<dt>Возвращаемое значение</dt><dd>
1 при успешном выполнении, 0 при ошибке, -1 если не поддерживается. WebAssembly всегда возвращает -1.
</dd>
<dt>Смотрите также</dt><dd>
...
<dl>
<dt>Описание</dt><dd>
Указывает, что игрок хочет присоединиться к игре по локальной сети. Не блокирует, [net_conn] сообщает
...
<dt>Возвращаемое значение</dt><dd>
Возвращает 0, если соединение ещё не установлено, 1 в режиме ожидания и 2, если соединение
установлено.
</dd>
<dt>Смотрите также</dt><dd>
[net_host], [net_join]
...
<dl>
<dt>Описание</dt><dd>
Получение сообщения от пира.
</dd>
<dt>Параметры</dt><dd>
| Аргум. | Описание |
| peer | адрес идентификатора отправителя, от 0x30000 до 0xBFFFC |
| msg | адрес большого буфера размером 1024 байта, от 0x30000 до 0xBFFFF |
</dd>
<dt>Возвращаемое значение</dt><dd>
Длина сообщения и сообщение в `msg`, 0 означает отключение, `peer` равен -1, если сообщения не было.
</dd>
<dt>Смотрите также</dt><dd>
[net_send]
</dd>
...
<dl>
<dt>Описание</dt><dd>
Отправляет сообщение пиру или всем подключенным пирам, если `peer` равен -1.
</dd>
<dt>Параметры</dt><dd>
| Аргум. | Описание |
| peer | идентификатор целевого пира или -1 для отправки всем подключенным пирам |
| msg | сообщение, адрес большого буфера размером не более 1024 байт, от 0x30000 до 0xBFFFF |
| len | длина сообщения, от 1 до 1024 |
</dd>
<dt>Возвращаемое значение</dt><dd>
1 в случае успеха, 0 в случае ошибки.
</dd>
