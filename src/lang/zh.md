...
编辑源代码时，您还可以使用其他 [键盘] 快捷键：

| 键 | 说明 |
|------------------------------|-----------------------------------------------------------|
| <kbd>Ctrl</kbd>+<kbd>F</kbd> | 查找字符串 |
| <kbd>Ctrl</kbd>+<kbd>G</kbd> | 再次查找 |
| <kbd>Ctrl</kbd>+<kbd>H</kbd> | 搜索和替换（在选定的文本中，或者如果没有选定的文本，则在整个源代码中）|
| <kbd>Ctrl</kbd>+<kbd>J</kbd> | 转到行 |
| <kbd>Ctrl</kbd>+<kbd>D</kbd> | 转到函数定义 |
| <kbd>Ctrl</kbd>+<kbd>N</kbd> |列出书签 |
...
| <kbd>End</kbd> | 将光标移动到行末 |
| <kbd>PgUp</kbd> |将光标向上移动 42 行（一页） |
| <kbd>PgDown</kbd> | 将光标向下移动 42 行（一页） |
| <kbd>F1</kbd> | 如果光标位于 API 的参数列表中，则转到函数的内置帮助页面 |

无论平台的键盘布局如何，编程所需的所有字符（以及更多）始终都可以访问：
